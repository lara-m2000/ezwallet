...
|374| gruop should be removed | deleteGroup | Unit | WB |
|375| shold return error if group does not exist | deleteGroup | Unit | WB |
|376| should retrieve list of all users | getUsers | Integration | BB |
|377| should return error if user requesting is not Admin | getUsers | Integration | BB |
|378| should return my user | getUser | Integration | BB |
|379| should return another user when making Admin request | getUser | Integration | BB |
|380| should return error if user does not exist | getUser | Integration | BB |
|381| should return error if user tryies to get another user | getUser | Integration | BB |
|382| should return deleted user | deleteUser | Integration | BB |
| 383 | should return error if requesting user is not Admin | deleteUser | Integration | BB |
| 384 | should return error if user doesn't exist | deleteUser | Integration | BB |
| 385 | should return removed transactions | deleteUser | Integration | BB |
| 386 | should return removed transactions and removed group | deleteUser | Integration | BB |
| 387 | should create a new group | createGroup | Integration | BB |
| 388 | should return error if group already exists | createGroup | Integration | BB |
| 389 | should return non exising users | createGroup | Integration | BB |
| 390 | should return non exising users in a group | createGroup | Integration | BB |
| 391 | should return error if users do not exist or belog to a group | createGroup | Integration | BB |
| 392 | should return list of groups | getGroups | Integration | BB |
| 393 | should return empty list | getGroups | Integration | BB |
| 394 | should return error if user requesting is not Admin | getGroups | Integration | BB |
| 395 | should return a group | getGroup | Integration | BB |
| 396 | should return error if groups does not exist | getGroup | Integration | BB |
| 397 | should return error if user requestin is not part of the group | getGroup | Integration | BB |
| 398 | should return group if user if user is admin | getGroup | Integration | BB |
| 399 | should add new users to a group | addToGroup | Integration | BB |
| 400 | should add new users to a group with Admin role | addToGroup | Integration | BB |
| 401 | should return error if group doesn't exist | addToGroup | Integration | BB |
| 402 | should return non exising users | addToGroup | Integration | BB |
| 403 | should return users in a group | addToGroup | Integration | BB |
| 404 | should return error if users do not exist or belog to a group | addToGroup | Integration | BB |
| 405 | return error if user requesting is not part of the group | addToGroup | Integration | BB |
| 406 | should remove users from a group | removeFromGroup | Integration | BB |
| 407 | should remove users from a group with Admin role | removeFromGroup | Integration | BB |
| 408 | should return error if group doesn't exist | removeFromGroup | Integration | BB |
| 409 | should return non existing users | removeFromGroup | Integration | BB |
| 410 | should return users not in a group | removeFromGroup | Integration | BB |
| 411 | should return error if users don't exist or don't belog to a group | removeFromGroup | Integration | BB |
| 412 | should return error if user is not part of the group | removeFromGroup | Integration | BB |
| 413 | group should be removed | deleteGroup | Integration | BB |
| 414 | should return error if group does not exist | deleteGroup | Integration | BB |
| 415 | should return error if requesting user if not Admin | deleteGroup | Integration | BB |
